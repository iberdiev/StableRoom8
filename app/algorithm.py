...
import json
@shared_task
def generate_matchings(list):
    list = json.loads(list)
    for survey in list:
        data_list = [survey['fields']['full_name'],
                     survey['fields']['country'],#(0-KG, 1-TJ, 2-KZ)
                     survey['fields']['campus'], #(0-Naryn, 1-Khorog, 2-Tekeli)
                     survey['fields']['gender'], #(0-male, 1-female)
                     survey['fields']['year'], #(0-prep ... 4-senior)
                     survey['fields']['scale1'],
                     survey['fields']['scale2'],
                     survey['fields']['scale3'],
                     survey['fields']['scale4'],
                     survey['fields']['scale5'],
                     survey['fields']['scale6'],
                     survey['fields']['scale7'],
                     survey['fields']['scale8'],
                     ]
        print (data_list)
